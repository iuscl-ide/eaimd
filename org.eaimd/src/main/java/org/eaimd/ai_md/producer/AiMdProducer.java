...
package org.eaimd.ai_md.producer;

import java.util.Arrays;

import org.eaimd.ai_md.parser.ext.references.AiMdReferenceBlock;
import org.eaimd.ai_md.parser.ext.references.AiMdReferencesExtension;
import org.eaimd.ai_md.producer.caller.AiMdCaller;
import org.eaimd.ai_md.producer.model.AiMdReferenceHeader;
        ...
        public void process(@NotNull NodeTracker state, @NotNull Node node) {
        	...
        	if (node instanceof AiMdReferenceBlock) {
        		...
        		if ((aiMdReferenceBlock.getHeaderEndLineNumber() < editorLine[0]) && (editorLine[0] < aiMdReferenceBlock.getEndLineNumber())) {
            		...
            		String aiResultText = aiMdReferenceHeader.getId() + " -- " + AiMdCaller.callRephrase(aiSourceText);
