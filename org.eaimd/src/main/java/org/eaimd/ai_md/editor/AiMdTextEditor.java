...
import org.eaimd.ai_md.editor.folding.AiMdReferenceHeaderFoldingProjectionAnnotation;
import org.eaimd.ai_md.editor.range_indication.AiMdRangeIndicationStrategy;
...
public class AiMdTextEditor extends ExtensionBasedTextEditor {
	...
	static {
		try {
			...
			log.fatal("Reflection error for: fContentAssistant", exception);
		}
	}

	public static final String MARKER_REFERENCE_BEGIN = "org.eaimd.ai-md.reference.begin.marker";
	public static final String MARKER_REFERENCE_TEXT_BEGIN = "org.eaimd.ai-md.reference.text.begin.marker";
	public static final String MARKER_REFERENCE_TEXT_END = "org.eaimd.ai-md.reference.text.end.marker";

//	public static final String MARKER_REFERENCE_BEGIN = "org.eaimd.ai-md.reference.line.text.marker";
//	public static final String MARKER_REFERENCE_TEXT_BEGIN = "org.eaimd.ai-md.reference.start.line.text.marker";
//	public static final String MARKER_REFERENCE_TEXT_END = "org.eaimd.ai-md.reference.end.line.text.marker";
...
//		
//	    IMarker[] referenceMarkers = resource.findMarkers("org.eaimd.ai_md.reference.line.text.marker", true, IResource.DEPTH_INFINITE);
