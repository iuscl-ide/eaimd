...
import org.eaimd.activator.App;
import org.eaimd.ai_md.editor.outline.AiMdOutlinePage;
import org.eaimd.ai_md.preferences.AiMdPreferencesAiProducer;
import org.eaimd.ai_md.preferences.AiMdPreferencesAiProducer.AiMdPreferencesAiProducerField;
import org.eaimd.ai_md.preferences.AiMdPreferencesHtmlGenerator;
import org.eaimd.ai_md.preferences.AiMdPreferencesHtmlGenerator.AiMdPreferencesHtmlGeneratorField;
import org.eaimd.ai_md.preferences.AiMdPreferencesHtmlGenerator.CodeStyles;
import org.eaimd.ai_md.preferences.AiMdPreferencesHtmlGenerator.CssStyles;
import org.eaimd.ai_md.preferences.AiMdPreferencesMdFormatter;
import org.eaimd.ai_md.preferences.AiMdPreferencesMdFormatter.AiMdPreferencesMdFormatterField;
import org.eaimd.ai_md.repo.AiMdRepo;
import org.eaimd.ai_md.resources.CR;
import org.eaimd.ai_md.ui.UI;
import org.eaimd.ai_md.ui.components.AiMdUiBooleanControl;
import org.eaimd.ai_md.ui.components.AiMdUiControl;
import org.eaimd.ai_md.ui.components.AiMdUiControls;
import org.eaimd.ai_md.ui.components.AiMdUiIntegerControl;
...
public class AiMdMultiPageEditor extends FormEditor {
	...
	static {
		try {
			...
			log.fatal("Reflection error for: nestedEditors_Field", exception);
		}
		...
		try {
			...
			log.fatal("Reflection error for: registerPage_Method", exception);
		}
		...
		try {
			...
			log.fatal("Reflection error for: updatePageIndices_Method", exception);
		}
	}
	/* < Reflection */
	...
	private void createMdPreferencesSection(FormToolkit formsToolkit, Composite containerFormComposite) {
		...
		/* Run */
		mdSectionToolBarManager.add(UI.ActionFactory.create("org.eaimd.ai_md.editor.mdSection.reset",
			"", "Reset to Default Values", CR.getImageDescriptor("initializ_parameter_context"), () -> {
		...
		mdSectionToolBarManager.add(UI.ActionFactory.create("org.eaimd.ai_md.editor.mdSection.reload",
			"", "Reload from Saved Values", CR.getImageDescriptor("reload_nav_16"), () -> {
		...
		mdSectionToolBarManager.add(UI.ActionFactory.create("org.eaimd.ai_md.editor.mdSection.save",
			"", "Save Values", CR.getImageDescriptor("save"), () -> {
	...
	private void createHtmlPreferencesSection(FormToolkit formsToolkit, Composite containerFormComposite) {
		...
		/* Run */
		htmlSectionToolBarManager.add(UI.ActionFactory.create("org.eaimd.ai_md.editor.htmlSection.reset",
			"", "Reset to Default Values", CR.getImageDescriptor("initializ_parameter_context"), () -> {
		...
		htmlSectionToolBarManager.add(UI.ActionFactory.create("org.eaimd.ai_md.editor.htmlSection.reload",
			"", "Reload from Saved Values", CR.getImageDescriptor("reload_nav_16"), () -> {
		...
		htmlSectionToolBarManager.add(UI.ActionFactory.create("org.eaimd.ai_md.editor.htmlSection.save",
			"", "Save Values", CR.getImageDescriptor("save"), () -> {
...
//		aiMdTextEditor.initReferences();
	...
	protected void addPages() {
		...
		if (rootAiPreferencesPath != null) {
			log.error("No \".ai-preferences.yaml\" file found on project parent folders");
		}
